          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        >
                          ...
                          />
                          <path
                            d="M6.10322 16.9876H2.53135C1.5751 16.9876 0.787598 17.7742 0.787598 18.7304V19.2438C0.787598 20.2001 1.5751 20.9876 2.53135 20.9876H6.10322C7.05947 20.9876 7.84697 20.2001 7.84697 19.2438V18.7001C7.8751 17.7157 7.0876 16.9282 6.10322 16.9282ZM6.60947 19.272C6.60947 19.5532 6.38447 19.7782 6.10322 19.7782H2.53135C2.2501 19.7782 2.0251 19.5532 2.0251 19.272V18.7001C2.0251 18.4188 2.2501 18.1938 2.53135 18.1938H6.10322C6.38447 18.1938 6.60947 18.4188 6.60947 18.7001V19.272Z"
                            fill=""
                          />
                          <path
                            d="M15.4689 16.9876H11.8971C10.9408 16.9876 10.1533 17.7742 10.1533 18.7304V19.2438C10.1533 20.2001 10.9408 20.9876 11.8971 20.9876H15.4689C16.4252 20.9876 17.2127 20.2001 17.2127 19.2438V18.7001C17.2127 17.7157 16.4252 16.9282 15.4689 16.9282ZM15.9752 19.272C15.9752 19.5532 15.7502 19.7782 15.4689 19.7782H11.8971C11.6158 19.7782 11.3908 19.5532 11.3908 19.272V18.7001C11.3908 18.4188 11.6158 18.1938 11.8971 18.1938H15.4689C15.7502 18.1938 15.9752 18.4188 15.9752 18.7001V19.272Z"
                            fill="white"
                          />
                        </svg>
                        Dashboard
              ...
              <li>
                ...
                >
                  <CctvIcon /> {/* Menggantikan SVG dengan komponen CctvIcon */}
                  Camera
                </NavLink>
              </li>
              {/* <!-- Menu Item Calendar --> */}
              ...
              <li>
                ...
                >
                  <UserIcon /> {/* Menggantikan SVG dengan komponen CctvIcon */}
                  Profile
                </NavLink>
              </li>
              {/* <!-- Menu Item Profile --> */}
