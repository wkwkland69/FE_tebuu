  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        <CardDataStats
          title="Total Tebu yang sudah di-scan"
          total={totalTebu !== null ? totalTebu.toString() : 'Loading...'}
          rate="0.95%"
          levelDown
        >
          <svg
        ...
        {/* Tambahkan elemen kosong untuk mengisi grid jika jumlah card kurang dari 4 */}
      ...
      <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
        ...
        <ChartThree />
        <MapOne />
        <div className="col-span-12 xl:col-span-max">
          <TableOne />
        </div>
        {/* <ChatCard /> */}
      </div>
